...
|---------------------|---------------------------------------------|-----------------------------------|-----------------|
| QBO_CLIENT_ID ,QBO_CLIENT_SECRET      | ID y secreto de la app QBO (OAuth2)                   | Rota según la aplicación         | Data Eng / TI   |
| QBO_REFRESH_TOKEN   | Necesario para poder generar access_token     |Rota por expiración o por cantidad de usos | Data Eng / TI   |
...
> En la carpeta del proyecto definimos un .env que contiene las credenciales para poder arrancar Postgres.
---
